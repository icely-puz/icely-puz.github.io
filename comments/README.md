...
`recent.html` shows the newest 100 approved comments. The article list uses
the backend's `counts` action to show approved comment totals. Redeploy
`comments_appsscript.js` before publishing these frontend files.
